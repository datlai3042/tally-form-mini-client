...
const buttons: ButtonInputType[] = [
	...
	{ type: "OPTION", Icon: <ListChecks className="text-textMain" size={18} />, content: "Option" },
	{ type: "OPTION_MULTIPLE", Icon: <ListTodo className="text-textMain" size={18} />, content: "Option Multiple" },
