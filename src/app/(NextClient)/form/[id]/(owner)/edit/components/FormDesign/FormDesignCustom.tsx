...
const FormDesignCustom = () => {
	...
	return (
		<div className="scroll-desgin-custom fixed xl:sticky z-[102] top-0 xl:top-[-.1rem] xl:mt-[2rem] right-[0rem] h-screen overflow-y-scroll w-[28rem]  xl:w-[34rem]  bg-[#222] shadow-lg">
